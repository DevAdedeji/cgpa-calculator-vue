<template>
    <section>
        ...
        <div class="calculator">
            ...
            <table>
                ...
                <tr v-for="(item, index) in courseList" :key="index"> 
                    ...
                    <td>
                        <select ref="courseGrade" v-model="item.courseGrade" @click="GradeChange">
                            <option>A</option>
                            <option>B</option>
                            <option>C</option>
                            <option>D</option>
        ...
        <div class="result">
                ...
                <!-- Result -->
                <div class="result">
                    <p id="gpa" ref="gpa">{{firstSemesterGPA}}</p>
                    <p id="class">{{sclass}}</p>
                </div>
        </div>
...
export default {
    ...
    methods:{
        ...
        calculate(){ 
            ...
            // Calculating the firstSemesterGPA by dividing the scores of all courses by the sum of all courses unit
            this.firstSemesterGPA = sumOfScores / this.sumOfCoursesUnit
            this.firstSemesterGPA = this.firstSemesterGPA.toFixed(2)

            this.getStudentClass()  
            this.$emit('firstSemesterGpa', this.firstSemesterGPA)
        },
        GradeChange(){
            this.firstSemesterGPA = 0
            this.sclass = ''
